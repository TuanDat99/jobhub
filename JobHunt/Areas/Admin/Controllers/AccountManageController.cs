    ...
    public class AccountManageController : Controller
    {
        ...
        public JsonResult DeleteAccount(int? idwebmt)
        {
            ...
            else
            {
                ...
                if (resultCode == 1)
                {
                    resultMessage = "Delete Succesfull";
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    {
                        ...
                        if (listRolesName.Intersect(rolenames).Any())
                        {
                            ...
                            {
                                messageResult = "Please check your email and confirm your account!";
                            }
                            else if(getUser.WIStatus != (int)BU.Common.Enum.StatusAccount.Active)
                            {
                                messageResult = "Your account has been locked or there is a problem, please contact admin for support!";
                            }
                            else
                            {
                        ...
                        {
                            messageResult = "You do not have access";
                        }
                ...
                case SignInStatus.LockedOut:
                    return Json(new { message = "Your account has been locked!", status = "error" }, JsonRequestBehavior.AllowGet);
